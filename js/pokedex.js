...
$("#Pokedex").on('click','tr',function(e){
    ...
    pokemonRow = $(this).attr('value');
       ...
       "</h3></a></div><div class='modal-body'><h5>Abilities: Test2 </h5><p>";
       for(var x = 0; x < Pokemon[pokemonRow].abilities.length; x++){
       	html2 += Pokemon[pokemonRow].abilities[x];
       	if (Pokemon[pokemonRow].abilities.length == x){alert(Pokemon[pokemonRow].abilities[x]);}
       }
