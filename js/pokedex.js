...
$("#Pokedex").on('click','tr',function(e){
    ...
    pokemonRow = $(this).attr('value');
       ...
       "</h3></a></div><br /><a href='#'><img src='{{ site.baseurl }}/Mega-Evolve/assets/images/pokemon/" + Pokemon[pokemonRow].num + ".png' id='PokemonModalImage'></a><div class='modal-body'><table><tr><th>Height</th><td>"
