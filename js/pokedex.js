...
$("#Pokedex").on('click','tr',function(e){
    ...
    Pokemon[pokemonRow].species.hp +"</td><td></td><td></td><td></td><td></td><td></td></tr></table></div><div class='modal-footer'><a class='btn btn-default' data-dismiss ='modal'>Close</a></div>");
