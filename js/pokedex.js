...
$("#Pokedex").on('click','tr',function(e){
    ...
    pokemonRow = $(this).attr('value');
       ...
       html2 += "</td></tr></table><p><strong>Abilities:</strong> " + Pokemon[pokemonRow].abilities[0]; 
       if(Pokemon[pokemonRow].abilities[1] !== undefined){html2 += " & " + Pokemon[pokemonRow].abilities[1];}
	if(Pokemon[pokemonRow].abilities.H !== undefined){html2 += "<br /><strong>Hidden Abilitiy:</strong> "
